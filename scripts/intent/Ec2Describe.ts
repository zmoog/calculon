 ...
 */
@injectable()
export class Ec2DescribeIntent implements Intent<Ec2DescribeEntities, SlackMessage> {
    ...
    async execute(executionId: string, entities: Ec2DescribeEntities): Promise<SlackMessage> {
...
export type Ec2DescribeEntities = {
    environment: string
};